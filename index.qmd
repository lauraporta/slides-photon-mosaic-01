...
```{mermaid}  
flowchart LR
  raw --> contrast_enhancement --> suite2p --> get_df_over_f -->custom["make_figures.py"]
```
...
→ LLMs are fast but not deep (yet)

---

## What's the Future of Development?

- What is the best use of our time when using LLMs?
- How can we build more better and faster tools by leveraging LLMs?
- How has your workflow changed since using LLMs?
